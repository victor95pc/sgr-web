!function (e) {
    e.jgrid = e.jgrid || {}, e.extend(e.jgrid, {defaults: {recordtext: "Visualizzati {0} - {1} di {2}", emptyrecords: "Nessun record da visualizzare", loadtext: "Caricamento...", pgtext: "Pagina {0} di {1}"}, search: {caption: "Ricerca...", Find: "Cerca", Reset: "Pulisci", odata: [
        {oper: "eq", text: "uguale"},
